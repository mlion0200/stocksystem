...
StockItem::StockItem(unsigned int skuid, string desc, double p)
{
  sku = skuid;
...
// Accessors
unsigned int StockItem::GetSKU() const
{
  return sku;
}
...
unsigned int StockItem::GetStock() const
{
  return stock;
}
